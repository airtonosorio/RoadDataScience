#Nessa mesma tabela de cadastro de filiais, há uma coluna com as informações da 
#quantidade de pessoas colaboradoras e o(a) gestor(a) gostaria de ter um agrupamento
...
#('ES', 14), ('SP', 10), ('MG', 12)]
#A partir da lista de tuplas, crie um dicionário em que as chaves são os nomes dos
#Estados únicos e os valores são as listas com o número de colaboradores(as) 
